...
public class Fragment1 extends Fragment {
    ...
    public static MainActivity.ingredientDBcheck check1; //ingredeintDBcheck 클래스 생성.//비교해보는 클래스
    public static MainActivity.SkinTypeDBcheck check2;/////////////
    public static MainActivity.SkinTypeDBcheck check3;
    public static MainActivity.allergyDBcheck checkall;
    ...
    private void callCloudVision(final Bitmap bitmap) {
        ...
        try {
            AsyncTask<Object, Void, String> labelDetectionTask = new MainActivity.LableDetectionTask(this, prepareAnnotationRequest(bitmap));
