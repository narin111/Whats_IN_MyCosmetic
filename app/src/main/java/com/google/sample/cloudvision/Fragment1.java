...
public class Fragment1 extends AppCompatActivity{//Fragment
    ...
    public static void setDB(Fragment1 ctx) {
    ...
    /////
    public static void setDB_Type(Fragment1 ctx) {
