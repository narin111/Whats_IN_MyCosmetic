...
public class Fragment3 extends AppCompatActivity{//Fragment

    /*
    // @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup containter, Bundle savedInstanceState) {
        return inflater.inflate(R.layout.fragment1, containter, false);

    }*/

    /*
    @ContentView
    public Fragment1(@LayoutRes int contentLayoutId) {
        this();
        mContentLayoutId = contentLayoutId;
    }
*/
    //mContentLayoutId = R.layout.fragment1;
    @Nullable
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        if (R.layout.fragment3 !=0) {
    ...
    public static void setDB(Fragment3 ctx) {
    ...
    /////
    public static void setDB_Type(Fragment3 ctx) {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        fab.setOnClickListener(view -> {
            AlertDialog.Builder builder = new AlertDialog.Builder(Fragment3.this);
            builder
    ...
    private static class LableDetectionTask extends AsyncTask<Object, Void, String> {
        private final WeakReference<Fragment3> mActivityWeakReference;
        private Vision.Images.Annotate mRequest;

        LableDetectionTask(Fragment3 activity, Vision.Images.Annotate annotate) {
        ...
        protected void onPostExecute(String result) {
            Fragment3 activity = mActivityWeakReference.get();
