...
public class Fragment2 extends AppCompatActivity{//Fragment
...
*/
    ...
    public static void setDB(Fragment2 ctx) {
    ...
    /////
    public static void setDB_Type(Fragment2 ctx) {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        fab.setOnClickListener(view -> {
            AlertDialog.Builder builder = new AlertDialog.Builder(Fragment2.this);
            builder
    ...
    private static class LableDetectionTask extends AsyncTask<Object, Void, String> {
        private final WeakReference<Fragment2> mActivityWeakReference;
        private Vision.Images.Annotate mRequest;

        LableDetectionTask(Fragment2 activity, Vision.Images.Annotate annotate) {
        ...
        protected void onPostExecute(String result) {
            Fragment2 activity = mActivityWeakReference.get();
